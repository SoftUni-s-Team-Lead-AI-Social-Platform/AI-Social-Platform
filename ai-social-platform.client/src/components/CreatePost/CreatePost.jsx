    ...
    <>
      ...
      <section className={styles["create-post-section"]}>
        <div className={styles["section-header"]}>
          ...
          <p onClick={closeCreateForm} className={styles["close-button"]}>
            X
          </p>
        </div>
        ...
        <form onSubmit={handleSubmit} className={styles["create-form"]}>
          ...
          <div className={styles["media-input"]}>
            ...
            >
              Add images{" "}
              <span className={styles["drag-drop"]}>or drag and drop</span>
            </label>
            <input
              ...
              multiple
              onChange={(e) => {
                setFieldValue(CreateFormKeys.PostMedia, e.target.files);
              }}
            />
          </div>
          <input
